...
always @(posedge clk_i, posedge host_intf_rst_i) begin: SDCNTL_SEQ_FUNC
    integer index;
...
always @(cmd_r, sData_r, sAddr_r, bank_s, sDataDir_r) begin: SDCNTL_SDRAM_PIN_MAP
    sd_intf_cke = 1;
    sd_intf_cs = 0;
    sd_intf_ras = cmd_r[2];
    sd_intf_cas = cmd_r[1];
...
always @(activeRow_r[0], activeRow_r[1], activeRow_r[2], activeRow_r[3], rdPipeline_r, bank_s, sdramData_r, activeBank_r, wrTimer_r, sd_intf_dq, row_s, rasTimer_r, activeFlag_r[0], activeFlag_r[1], activeFlag_r[2], activeFlag_r[3]) begin: SDCNTL_DO_ACTIVE
