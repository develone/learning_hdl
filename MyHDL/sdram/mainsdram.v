...
always @(posedge clk) begin: MAINSDRAM_DEBOUNCE_PB
...
always @(posedge clk, posedge sdramdevfsm0_0_host_intf_rst_i) begin: MAINSDRAM_SDRAMCNTL0_0_SEQ_FUNC
    integer index;
...
always @(SdramCntl0_0_cmd_r, SdramCntl0_0_sData_r, SdramCntl0_0_sAddr_r, SdramCntl0_0_bank_s, SdramCntl0_0_sDataDir_r) begin: MAINSDRAM_SDRAMCNTL0_0_SDRAM_PIN_MAP
...
always @(posedge clk) begin: MAINSDRAM_INTERNAL_RESET
...
always @(posedge clk) begin: MAINSDRAM_SDRAMDEVFSM0_0_SDRAM_FSM
    if ((reset == 1'b1)) begin
...
always @(posedge clk) begin: MAINSDRAM_SDRAMDEVFSM0_0_DATA_DELAY0_0_1_DELAYED
