...
`include "builddate.v"
	...
	// Wishbone slave definitions for bus wb, slave sdcntl
	wire		sdcntl_sel, sdcntl_ack, sdcntl_stall;
	wire	[31:0]	sdcntl_data;
...
//x2	Was a master bus as well
	...
	assign	      sdcntl_sel = ((wb_addr[22:19] &  4'hf) ==  4'h5); // 0xa00000 - 0xa01fff
