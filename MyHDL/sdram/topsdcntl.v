...
always @(posedge clk) begin: TOPSDCNTL_DEBOUNCE_PB
...
always @(posedge clk, posedge sdramdevfsm0_0_host_intf_rst_i) begin: TOPSDCNTL_SDRAMCNTL0_0_SEQ_FUNC
    integer index;
...
always @(SdramCntl0_0_cmd_r, SdramCntl0_0_sData_r, SdramCntl0_0_sAddr_r, SdramCntl0_0_bank_s, SdramCntl0_0_sDataDir_r) begin: TOPSDCNTL_SDRAMCNTL0_0_SDRAM_PIN_MAP
...
always @(posedge clk) begin: TOPSDCNTL_INTERNAL_RESET
...
assign SdramCntl0_0_host_intf_wr_i = (sdramdevfsm0_0_wr_enable && (!SdramCntl0_0_host_intf_done_o));
assign SdramCntl0_0_host_intf_rd_i = (sdramdevfsm0_0_rd_enable && (!SdramCntl0_0_host_intf_done_o));
assign SdramCntl0_0_host_intf_data_i = sdramdevfsm0_0_rand_val;
assign SdramCntl0_0_host_intf_addr_i = sdramdevfsm0_0_address;
assign o_wb_data = SdramCntl0_0_host_intf_data_o;


always @(posedge clk) begin: TOPSDCNTL_SDRAMDEVFSM0_0_SDRAM_FSM
    if ((reset == 1'b1)) begin
        ...
        if (((i_wb_cyc == 1) && (i_wb_sel == 15))) begin
            ...
            if ((i_wb_we == 1)) begin
                ...
                if ((SdramCntl0_0_host_intf_done_o == 0)) begin
...
always @(posedge clk) begin: TOPSDCNTL_SDRAMDEVFSM0_0_DATA_DELAY0_0_1_DELAYED
